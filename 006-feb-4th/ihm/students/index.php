...
<main>
  <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
    <div class="flex flex-wrap mb-4 justify-end">
      <a href="/ihm/students/form.php?action=add"
          ...
          <div class="flex items-center border-gray-200 border p-4 rounded-lg">
            <div class="flex-grow">
              <h2 class="text-gray-900 title-font font-medium">
                <a href="/ihm/absences/index.php?cne=<?= $student['cne'] ?>">
                  <?= $student['name'] ?>
                </a>
              </h2>
              <p class="text-gray-500">
                <?= $student['cne'] ?> / <?= $student['group'] ?>
              </p>
            </div>
            <a class="p-3" href="/ihm/students/form.php?action=update&cne=<?= $student['cne'] ?>">
            ...
            <a class="p-3" href="/ihm/students/index.php?confirm=<?= $student['cne'] ?>">
        ...
        <div class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
          ...
          <div class="fixed inset-0 z-10 overflow-y-auto">
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
              <form action="/tasks/students.php?action=delete"
                class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg"
                method="post">
                <input type="hidden" name="cne" value="<?= g('confirm') ?>">
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <div class="mt-2">
                        <p class="text-sm text-gray-500">Are you sure you want to delete student? All
