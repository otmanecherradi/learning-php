          ...
          <div class="flex items-center border-gray-200 border p-4 rounded-lg">
            <div class="flex-grow">
              ...
              <p class="text-gray-500">
                Role:
                <?= $user->getStudentCNE() ? 'student' : 'admin' ?>
              </p>
            </div>
            <a class="p-3" href="/ihm/users/form.php?action=update&id=<?= $user->getId() ?>">
            ...
            <a class="p-3" href="/ihm/users/index.php?confirm=<?= $user->getId() ?>">
